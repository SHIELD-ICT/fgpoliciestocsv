...
option_1 = { 'name' : ('-o', '--output-file'), 'help' : '<OUTPUT_FILE>: output csv file (default \'./vipes-out.csv\')', 'default' : 'vipes-out.csv', 'nargs' : 1}
...
def parse(fd):
	"""
		...
		@rtype:	return a list of vipes ( [ {'id' : '1', 'srcintf' : 'internal', ...}, {'id' : '2', 'srcintf' : 'external', ...}, ... ] )  
